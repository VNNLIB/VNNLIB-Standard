...
\item $\semTensorAbs$ - a function mapping each syntactic tensor to a mathematical tensor of the required type and shape.
\item $\semModelAbs$ - a function mapping each syntactic model to an executable function from a list of input mathematical tensors of the required shape to a list of output mathematical tensors of the required shape.
