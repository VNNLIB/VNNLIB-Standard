...
\section{Semantics of ONNX models}
...
\section{Solver support for ONNX in practice}
...
To promote clarity and interoperability, the \vnnlib{} command-line interface includes a mechanism for querying the extent of a particular solver's support for the ONNX standard (see Section~\ref{sec:global_capabilities}). This mechanism allows solvers to explicitly report the ONNX features they support, enabling toolchains and users to reason more effectively about compatibility.