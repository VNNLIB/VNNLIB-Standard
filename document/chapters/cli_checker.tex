...
When invoked with the \texttt{supports} command, the checker should report the types of queries and networks whose proof it can check, as well as the set of proof rules it is capable of checking
. As in the solver's \texttt{supports}, these options provide a way for higher-level tools to automatically assess the capabilities of the proof checker.
