...
Assertions use the constructed (static) context, and each of the variable references ? fetch the variables type for a given context i.e. $\Sigma $. For a \texttt{constant}, $\tau$ returns the ONNX element type $e$.
