...
\begin{figure}
    ...
    \begin{minipage}[t]{1\textwidth}
        ...
        \resizebox{\textwidth}{!}{
            ...
            $\langle$connExpr$\rangle$  & $\ni$ & $b ::= \texttt{literal} \;|\; \texttt{and} \;|\; \texttt{or}$ \\
    ...
    \begin{minipage}[t]{0.9\textwidth}
        ...
        \begin{mathpar}
            ...
            \inferrule*[Right=constant]{
                % i \in the set of assignable values to ONNX literals
            }{
                \Gamma, \Sigma \Vdash r : \texttt{constant} (\tau \ i) 
            }
            ...
            \inferrule*[Right=n-ary Arithmetic Expressions]{
            }{
