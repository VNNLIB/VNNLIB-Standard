        ...
        \begin{mathpar}
            ...
            \inferrule*[]{
                \ensuremath{
                    ...
                    \vdots & \vdots & \vdots & \\
                    \Gamma_{n-1} \vdash I_n : \Gamma_n & \Gamma_{m+n-1} \vdash H_m : \Gamma_{m+n} & \Gamma_{m+n+o-1} \vdash O_o : \Gamma_{n+m+o} & N_0 \vdash v : N_1
                    \end{array}
                }
            }{
            ...
            \inferrule*[]{
                \ensuremath{
                    \begin{array}{cccc}
                    \Gamma_0 \vdash I_1 : \Gamma_1 & \Gamma_n \vdash H_1 : \Gamma_{n+1} & \Gamma_{m+n} \vdash O_1 : \Gamma_{m+n+1} & \triangle \in \{\texttt{isomorphic-to},\texttt{equal-to}\}\\
                    \vdots & \vdots & \vdots & v_2 \in N_0\\
            ...
            \\
            \scalebox{0.9}{\textsf{\textsc{NetworkDeclaration CongruenceStatement}}} \\
            \end{mathpar}
        }
