...
In this case, the variables can be referenced without any indices, as shown in Line 8 below:
\begin{lstlisting}[style=lbnf]
(declare-network f
...
\end{equation*}
which is a mapping from the decared input/hidden/output variables to their shape and type.
