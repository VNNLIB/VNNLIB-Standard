...
Named dimensions are stored as a string in the model, while unnamed dimensions are stored as a null value in the model but are often written as ``-1'' for clarity. 
