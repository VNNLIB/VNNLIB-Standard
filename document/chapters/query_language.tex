...
\begin{figure}
    ...
    \caption{Scope construction judgments of Network Declaration}
    \end{minipage}
\end{figure}
...
\begin{figure}
    ...
    \caption{Scope construction judgments of Arithmetic Expressions}
    \end{minipage}
\end{figure}
...
\mytodo{lambda notation to construct context}
...
\mytodo{Semantics for ArithExpr}
