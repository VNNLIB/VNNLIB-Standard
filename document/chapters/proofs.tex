...
\begin{enumerate}
	\item \textbf{Assumptions:} Introduce formulas assumed to be correct. These can either be imported from the neural network or the \vnnlib{} specification being proved. To ease proof checking, the \vnnlib{} proofs need to specify the source of each assumption. The \texttt{assume\_n} command is used to import assumption from the network, and \texttt{assume\_q} imports assertions from the \vnnlib{} query.
	Additional assumptions can be assumed correct at a given subproof context, then they are defined by the plain \texttt{assume} command.
...
\begin{figure}[p]
	...
	(assume_n e1 (!(= (+ X_0_0 (- X_0_1 ) (- H_0_0_b)) 0.0):named e1))
	(assume_n e2 (!(= (+ (* 2.0 X_0_1) X_0_2 (- H_0_1_b)) 0.0):named e2))
	(assume_n e3 (!(= (+ H_0_1_f (- H_0_0_f) (- Y_0_0)) 0.0):named e3))
	...
	(assume_n l4 (!(>= H_0_0_f 0.0):named l4))
	(assume_n l5 (!(>= H_0_1_f 0.0):named l5))
