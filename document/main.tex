...
\versionVar ~
\equivVar ~
(\inputDeclVar_1~...~\inputDeclVar_n) ~
(\hiddenDeclVar_1~...~\hiddenDeclVar_m) ~
(\outputDeclVar_1~...~\outputDeclVar_o)
}
...
\newcommand{\networkImplementation}{f}
\newcommand{\networkImplementationSet}{F}
\newcommand{\networkImplementations}{[\networkImplementation_1 \ldots \networkImplementation_n]}
