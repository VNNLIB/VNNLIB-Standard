...
\begin{abstract}
This document presents \vnnlib{}, a standard that formalises the query language for solvers. The standard uses the 
...
command-line interface for solvers. The goal is to foster greater robustness and interoperability in the neural network verification 
landscape.
\end{abstract}
