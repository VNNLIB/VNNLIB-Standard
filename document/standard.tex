...
\newcommand{\exampleSolver}{solveNN}
\newcommand{\exampleChecker}{checkNN}
...
\author[1]{Ann Roy}
\author[1]{Allen Antony}
\author[1]{Matthew Daggitt}

\author[2]{Stefano Demarchi}
\author[2]{Andrea Gimelli}
\author[3]{Dario Guidotti}
\author[3]{Luca Pulina}
\author[2]{Armando Tacchella}


\affil[1]{University of Western Australia, Australia}
\affil[2]{University of Genoa, Italy}
\affil[3]{University of Sassari, Italy}
...
To this end, the standard defines: i) a formal syntax for defining satisfiability queries over neural networks, ii) a formal semantics for that syntax and iii) and a command-line interface for solvers.
\end{abstract}
...
\input{chapters/cli_solver.tex}
\input{chapters/cli_checker.tex}
